...
class SunriseSet_HelperTests: XCTestCase {
    func testDaylightLengthProgress() {
        ...
        var sunriseSet = SunriseSet(date: date, timeZone: timeZone, latitude: osloCoordinate.latitude, longitude: osloCoordinate.longitude)
        ...
        sunriseSet = SunriseSet(date: date, timeZone: timeZone, latitude: osloCoordinate.latitude, longitude: osloCoordinate.longitude)
        XCTAssertEqual(sunriseSet.daylightLengthProgress, 0)
