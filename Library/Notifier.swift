...
struct Notifier {
    ...
    static func formattedMessage(location: Location, date: Date) -> String {
        ...
        let generatedMessage = messageGenerator.messageForNotification(date: date, hemisphere: location.hemisphere, yesterdayDaylightLength: location.yesterdayDaylightLength, todayDaylightLength: location.todayDaylightLength, tomorrowDaylightLength: location.tomorrowDaylightLength)
